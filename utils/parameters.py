...
def load_args():
    ...
    parser.add_argument('--model', type=str, default='AlexNet', help='model name: [VGG13, AlexNet, ResNet18, MobileNetV2,ViT]')
    parser.add_argument('--dataset', type=str, default='mnist', help="name of dataset: [mnist, cifar10, cifar100, fashionmnist]")
    ...
    parser.add_argument('--m', type=float, default=0.1, help="margin")
    parser.add_argument('--y', type=float, default=0.1, help="y")
    parser.add_argument('--la', type=float, default=1, help="lambda")
    ...
    parser.add_argument('--device', type=str, default="cuda", help='Set the device to use: "cuda" or "cpu".')
    parser.add_argument('--seed', type=int, default=1, help='random seed (default: 1)')
    parser.add_argument('--save_dir', type=str, default="./result/")
    parser.add_argument('--save_model_dir', type=str, default="./result/")
    parser.add_argument('--save_bn_dir', type=str, default="./result/")
